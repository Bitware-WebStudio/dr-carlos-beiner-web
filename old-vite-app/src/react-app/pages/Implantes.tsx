...
import FinancingBar from '@/react-app/components/FinancingBar';
...
export default function Implantes() {
    ...
    return (
        <div className="min-h-screen">
            <Header />
            <main>
                {/* Hero Section - Estilo consistente con el resto del sitio */}
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                {[
                                    ...
                                    { q: "¿Puede el cuerpo rechazar un implante?", a: "La tasa de éxito es del 98%. Te explicamos qué factores influyen en la oseointegración.", link: "/tratamientos/implantes/guias/rechazo-implante" },
                                    ...
                                    { q: "Implante vs Puente vs Prótesis", a: "Comparamos las 3 opciones para que entiendas por qué el implante es la inversión más inteligente.", link: "/tratamientos/implantes/guias/implante-vs-puente-protesis" },
                                    ...
                                    <Link key={i} to={faq.link} className="card group hover:border-primary transition-all duration-300 flex flex-col h-full bg-neutral-50/30">
