...
export default function CostoImplantes() {
    ...
    useEffect(() => {
        document.title = '¿Por qué los implantes dentales son más caros? | Dr. Carlos Beiner';
    }, []);
        ...
        >
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-xl mb-8">
                ...
                <p className="text-blue-800">
                    Un implante puede parecer caro comparado con otras opciones, pero cuando lo analizas
                    <strong> por año de uso</strong>, suele ser la opción más económica a largo plazo.
            ...
            <h2 className="font-display font-bold text-2xl text-neutral-900 mt-12 mb-4">
                ¿Qué está incluido en el precio de un implante?
            </h2>
            ...
            <div className="bg-neutral-50 border border-neutral-200 rounded-xl p-6 my-6">
                <ol className="space-y-4">
                    <li>
                        <strong>1. Evaluación y diagnóstico</strong>
                        <p className="text-sm text-neutral-600 mt-1">Examen clínico, radiografías, scanner 3D si es necesario</p>
                    </li>
                    <li>
                        <strong>2. El implante (tornillo de titanio)</strong>
                        <p className="text-sm text-neutral-600 mt-1">Material de alta tecnología, certificado y biocompatible</p>
                    </li>
                    <li>
                        <strong>3. La cirugía de colocación</strong>
                        <p className="text-sm text-neutral-600 mt-1">Honorarios del cirujano, anestesia, materiales quirúrgicos</p>
                    </li>
                    <li>
                        <strong>4. El pilar (conector)</strong>
                        <p className="text-sm text-neutral-600 mt-1">La pieza que une el implante con la corona</p>
                    </li>
                    <li>
                        <strong>5. La corona definitiva</strong>
                        <p className="text-sm text-neutral-600 mt-1">El "diente" visible, fabricado a medida</p>
                    </li>
                    <li>
                        <strong>6. Controles post-operatorios</strong>
                        <p className="text-sm text-neutral-600 mt-1">Seguimiento durante todo el proceso</p>
                    </li>
                </ol>
            </div>

            <h2 className="font-display font-bold text-2xl text-neutral-900 mt-12 mb-4">
                ¿Por qué hay tanta diferencia de precios entre dentistas?
            </h2>
            ...
            <h2 className="font-display font-bold text-2xl text-neutral-900 mt-12 mb-4">
                ¿Por qué hay implantes "baratos" que cuestan la mitad?
            </h2>
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-r-lg my-6">
                ⚠️ <strong>Cuidado con precios muy bajos.</strong> Un implante premium tiene décadas de
                investigación, estudios clínicos que demuestran su éxito, y garantía del fabricante.
            ...
            <h2 className="font-display font-bold text-2xl text-neutral-900 mt-12 mb-4">
                Costo total a largo plazo: la verdadera comparación
            </h2>
            ...
            <div className="bg-neutral-50 border border-neutral-200 rounded-xl p-6 my-6">
                ...
                <ul className="space-y-4">
                    <li>
                        <strong className="text-green-700">Implante:</strong>
                        <span className="block text-sm text-neutral-600">Un implante que dura 30 años + cambio de corona a los 15 años</span>
                    </li>
                    <li>
                        <strong>Puente:</strong>
                        <span className="block text-sm text-neutral-600">Cambiar puente 2-3 veces en 30 años + posible tratamiento de dientes pilares si fallan</span>
                    </li>
                    <li>
                        <strong>Prótesis removible:</strong>
                        <span className="block text-sm text-neutral-600">Rehacer 4-5 veces en 30 años + rebasados periódicos + pérdida de hueso progresiva</span>
                    </li>
                </ul>
            ...
            <p>
                Muchos consultorios ofrecen opciones de financiamiento. En la consulta con el Dr. Carlos Beiner
            ...
            <p>
                El costo de un implante dental refleja <strong>décadas de investigación, materiales premium,
                    tecnología avanzada y la experiencia del profesional</strong>.
            </p>
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded-r-lg my-6">
                ✅ <strong>Consejo:</strong> No busques el implante más barato. Busca el mejor valor:
                un precio justo que incluya implantes de calidad, cirujano experimentado, y garantía real.
            </div>
            <p className="text-neutral-700">
                En tu evaluación con el Dr. Carlos Beiner recibirás un presupuesto detallado y transparente,
                con todo lo que está incluido y las opciones de pago disponibles.
            </p>
        </ArticleLayout>
    );
}
