...
export default function MuelasDelJuicio() {
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-display font-bold text-neutral-900 mb-12 text-center">
                Proceso de Extracción
              </h2>
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  <div className="w-16 h-16 rounded-full gradient-primary text-white font-bold text-2xl flex items-center justify-center mx-auto mb-4">
                    1
                  </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {faqs.map((faq, index) => (
                  <Link key={index} to={faq.link || '#'} className="card group hover:border-primary transition-all duration-300 flex flex-col h-full">
