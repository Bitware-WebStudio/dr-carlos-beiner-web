...
export default function Footer() {
    ...
    return (
        <footer className="bg-neutral-900 text-white">
            <div className="container mx-auto px-4 pt-12 pb-24 md:pb-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/" className="text-neutral-400 hover:text-white transition-colors">Inicio</Link></li>
                            <li><Link href="/servicios" className="text-neutral-400 hover:text-white transition-colors">Servicios</Link></li>
                            <li><Link href="/tratamientos/urgencias-dentales" className="text-neutral-400 hover:text-white transition-colors">Urgencias</Link></li>
                            <li><Link href="/ubicacion" className="text-neutral-400 hover:text-white transition-colors">Ubicación</Link></li>
                            <li><Link href="/contacto" className="text-neutral-400 hover:text-white transition-colors">Contacto</Link></li>
                        </ul>
                    </div>
