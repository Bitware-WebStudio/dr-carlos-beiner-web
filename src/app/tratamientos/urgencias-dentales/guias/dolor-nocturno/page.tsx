...
export default function DolorNocturno() {
    ...
    const schemaFAQ = {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "¿Por qué me duele más el diente de noche?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Al acostarte, aumenta el flujo de sangre hacia la cabeza, lo que incrementa la presión dentro del diente si el nervio está inflamado. Además, hay menos distracciones y los niveles de cortisol bajan."
                }
            },
            {
                "@type": "Question",
                "name": "¿Qué significa si el dolor me despierta?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Generalmente indica pulpitis irreversible (inflamación severa del nervio). Es una señal de que el diente necesita tratamiento de conducto o extracción prontamente."
                }
            },
            {
                "@type": "Question",
                "name": "¿Cómo puedo dormir si tengo dolor de muela?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Duerme semi-sentado con varias almohadas para reducir la presión. Toma un analgésico antiinflamatorio (como ibuprofeno) y evita comidas muy frías o calientes antes de dormir."
                }
            }
        ]
    };
