...
export const metadata: Metadata = {
    title: 'Se me cayó un diente por un golpe: ¿se puede salvar? | Dr. Carlos Beiner',
...
export default function DienteCaidoGolpe() {
    ...
    const schemaFAQ = {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "¿Cuánto tiempo tengo para salvar un diente que se cayó?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Tienes 30-60 minutos para tener las mejores probabilidades. Después de ese tiempo, las células de la raíz empiezan a morir. Actúa rápido."
                }
            },
            {
                "@type": "Question",
                "name": "¿Cómo debo transportar el diente caído?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "La mejor opción es ponerlo en un vaso con leche fría. Si no hay leche, puedes llevarlo dentro de tu boca (en la mejilla) con cuidado de no tragarlo. Nunca en agua ni seco."
                }
            },
            {
                "@type": "Question",
                "name": "¿Puedo intentar ponerme el diente yo mismo?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Si es un diente de adulto (permanente), sí. Enjuágalo suavemente con leche y colócalo en el hueco. Muerde una gasa y ve al dentista. Si es de leche, NO lo reimplantes."
                }
            }
        ]
    };
