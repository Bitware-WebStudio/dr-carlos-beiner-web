...
export const metadata: Metadata = {
    title: '¿Quedaré sin dientes durante el tratamiento de implantes? | Dr. Carlos Beiner',
...
export default function QuedareSinDientes() {
    ...
    const schemaFAQ = {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "¿Voy a estar sin dientes mientras cicatriza el implante?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "No. Siempre se usan dientes provisionales para que no tengas que estar con espacios vacíos. Pueden ser fijos (atornillados o pegados) o removibles, dependiendo de tu caso."
                }
            },
            {
                "@type": "Question",
                "name": "¿Qué es la carga inmediata?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Es una técnica que permite colocar el implante y un diente provisional fijo en el mismo día. No es para todos los casos, se requiere buena calidad de hueso y estabilidad inicial del implante."
                }
            },
            {
                "@type": "Question",
                "name": "¿Se nota mucho el diente provisional?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Muy poco. Los provisionales modernos se hacen del color de tus dientes y tienen una forma natural. Están diseñados para que puedas sonreír y desenvolverte socialmente sin problemas."
                }
            }
        ]
    };
