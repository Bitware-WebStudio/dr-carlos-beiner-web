...
export const metadata: Metadata = {
    title: '¿Duele ponerse un implante dental? | Dr. Carlos Beiner',
...
export default function DuelePonerse() {
    ...
    const backLink = { label: '← Volver a Implantes Dentales', href: '/tratamientos/implantes' };
        ...
        >
            <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-r-xl mb-8">
                ...
                <p className="text-green-800">
                    <strong>Muchos pacientes reportan que el implante dolió menos que una extracción.</strong> Durante el procedimiento no sientes nada gracias a la anestesia. Después, las molestias son manejables con analgésicos comunes y duran solo unos días.
                </p>
            </div>

            <h2 className="font-display font-bold text-2xl text-neutral-900 mt-12 mb-4">¿Durante el procedimiento duele?</h2>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg my-6">
                <p>💡 <strong>Si tienes mucha ansiedad:</strong> Se puede agregar sedación consciente. Estarás despierto pero muy relajado y probablemente no recuerdes mucho del procedimiento.</p>
            </div>

            <h2 className="font-display font-bold text-2xl text-neutral-900 mt-12 mb-4">¿Duele más que una extracción de muela?</h2>
            ...
            <h2 className="font-display font-bold text-2xl text-neutral-900 mt-12 mb-4">¿Qué tipo de anestesia se usa?</h2>
            ...
            <div className="space-y-4 my-6">
                ...
                <div className="bg-white border border-neutral-200 rounded-xl p-5">
                    ...
                    <p className="text-neutral-700">Para pacientes ansiosos o procedimientos más largos. Estás muy relajado pero técnicamente despierto. Necesitas acompañante.</p>
                </div>
                <div className="bg-white border border-neutral-200 rounded-xl p-5">
            ...
            <h2 className="font-display font-bold text-2xl text-neutral-900 mt-12 mb-4">¿Cuántos días de dolor real hay después?</h2>
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded-r-lg my-6">
                ✅ <strong>La clave:</strong> Toma los analgésicos según indicación las primeras 48 horas, aunque sientas que no te duele mucho. Es más fácil prevenir el dolor que quitarlo.
            </div>

            <h2 className="font-display font-bold text-2xl text-neutral-900 mt-12 mb-4">¿Qué medicamentos se toman?</h2>
            <p>Tipicamente te indicarán:</p>
            <ul>
            ...
            <h2 className="font-display font-bold text-2xl text-neutral-900 mt-12 mb-4">¿Puedo trabajar al día siguiente?</h2>
            ...
            <p className="mt-4"><strong>Consejo práctico:</strong> Si puedes, agenda el implante un jueves o viernes. Tendrás el fin de semana para la primera recuperación.</p>

            <h2 className="font-display font-bold text-2xl text-neutral-900 mt-12 mb-4">Conclusión</h2>
            <p>La mayoría de los pacientes se sorprenden gratamente de que <strong>el implante no fue tan doloroso</strong> como imaginaban. El miedo al dolor es generalmente peor que el dolor real.</p>
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded-r-lg my-6">
                ✅ <strong>Recuerda:</strong> El Dr. Carlos Beiner tiene más de 15 años de experiencia en implantes. Un cirujano experimentado significa procedimientos más rápidos, menos manipulación y, por lo tanto, menos molestias post‑operatorias.
            </div>
        </ArticleLayout>
    );
}
